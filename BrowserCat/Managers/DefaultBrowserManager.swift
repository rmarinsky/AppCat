...
final class DefaultBrowserManager {
    ...
    private func setDefaultApplication(at bundleURL: URL, contentTypes: [UTType], index: Int, state: AppState) {
    ...
    private func isDefaultForWebFileTypes() -> Bool {
        let contentTypes = BrowserFileType.defaultHandlerContentTypes
