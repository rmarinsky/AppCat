...
- Current PR verification: **258 headless unit tests passed, 0 failed**; the `AppCat UI Tests` target compiled with `build-for-testing` and was not launched interactively.
